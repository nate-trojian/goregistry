...
type Registry interface {
	// Register adds the interface's type to the mapping under a key
	Register(string, interface{})
	// FromJSON converts a JSON string into one of the types in the registry.
...
func New(keyFunc KeyFunction) Registry {
	return &registry{
		keyFunc: keyFunc,
